...
<h2>1. Fuel Business Insights — Reliance</h2>
    ...
    <ul>
        <li><strong>Total Revenue:</strong> ₹48.09bn from 495.85M liters sold across 5 cities</li>
        <li><strong>Profit:</strong> ₹3.71bn with a 7.7% profit margin</li>
        <li><strong>Top Fuel Type:</strong> Petrol leads with 224.87M liters (45.4% of volume), generating ₹23.5bn in revenue</li>
        <li><strong>Payment Dominance:</strong> UPI accounts for 42.1% of fuel revenue, followed by Cash (33.86%) and Card (24.05%)</li>
        <li><strong>Top Region:</strong> South region contributes 37.67% of total fuel profit</li>
        <li><strong>Capacity Utilization:</strong> Consistent at 77.91% average across all stations</li>
        <li><strong>Top Cities:</strong> Mumbai and Delhi lead with ₹10.6bn revenue each</li>
    </ul>
    <p>
 ...
 <h2>2. Fuel Regional & Station Performance</h2>
    ...
    <ul>
        <li><strong>South Region:</strong> Leading profit contributor at 37.67% (₹1.4bn)</li>
        <li><strong>West Region:</strong> Contributes 21.37% of profit (₹0.79bn)</li>
        <li><strong>North & East Regions:</strong> Both contribute ~21% each, showing balanced regional performance</li>
        <li><strong>Station Efficiency:</strong> Top station (FS221) generates ₹1.53bn in revenue</li>
        <li><strong>Monthly Trends:</strong> Revenue grew steadily from ₹6.3bn (Feb) to ₹8.6bn (May)</li>
        <li><strong>City Performance:</strong> Delhi shows highest capacity utilization at 60.55%, followed by Hyderabad at 58.07%</li>
    </ul>
    <p>
 ...
 <h2>3. Retail Business Insights — JioMart</h2>
    ...
    <ul>
        <li><strong>Total Revenue:</strong> ₹777.61M from 1.3M units sold</li>
        <li><strong>Profit:</strong> ₹86.20M with an 11.1% profit margin</li>
        <li><strong>Top Category:</strong> Electronics dominates with ₹594.61M (76.4% of retail revenue)</li>
        <li><strong>Channel Split:</strong> Offline drives 59.1% (₹459.47M), Online contributes 40.9% (₹318.14M)</li>
        <li><strong>Average Order Value:</strong> ₹55.09K with a low 3% return rate</li>
        <li><strong>Top Manager:</strong> Ankit leads with ₹73.70M revenue and ₹8.07M profit</li>
        <li><strong>Basket Growth:</strong> Average basket size increased 12.4% from ₹2,770 (Feb) to ₹3,114 (Jun)</li>
    </ul>
    <p>
  ...
  <h2>5. Executive Overview — Combined Performance</h2>
    ...
    <ul>
        <li><strong>Total Revenue:</strong> ₹49.76bn across both business units</li>
        <li><strong>Total Profit:</strong> ₹3.89bn with an average 7.8% profit margin</li>
        <li><strong>Revenue Split:</strong> Fuel contributes 96.8% (₹48.09bn), Retail 1.6% (₹777.61M)</li>
        <li><strong>Top Cities:</strong> Mumbai (₹10.6bn), Delhi (₹10.6bn), and Chennai (₹9.9bn) lead revenue</li>
        <li><strong>Monthly Trends:</strong> Profit margin remained stable at ~7.7-7.9% over 6 months</li>
        <li><strong>Regional Leaders:</strong> South region dominates fuel profit, while Mumbai and Delhi drive retail sales</li>
    </ul>
    <p>
...
<h2>Tools & Techniques Used</h2>
    ...
    <ul>
        <li><strong>Power BI:</strong> Created interactive dashboards with drill-down capabilities and cross-filtering</li>
        <li><strong>Power Query:</strong> Cleaned and transformed raw data from multiple sources</li>
        <li><strong>DAX Measures:</strong> Calculated profit margins, YTD performance, regional contributions, and growth rates</li>
